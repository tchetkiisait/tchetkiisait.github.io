...
/* layout(s) */
static const float mfact     = 0.55; /* factor of master area size [0.05..i0.95] */
...
static Key keys[] = {
	/* modifier                     key        fu`nction        argument */
	{ MODKEY,                       XK_F1,     spawn,          SHCMD("amixer -c 1 set Master toggle")},
        { MODKEY,                       XK_F2,     spawn,          SHCMD("amixer -c 1 set Master 5-")},
        { MODKEY,                       XK_F3,     spawn,          SHCMD("amixer -c 1 set Master 5+")},
